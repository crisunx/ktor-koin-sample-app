...
import br.com.crisun.sample.todo.domain.model.Status
...
internal class TaskRepositoryImpl(private val jdbcTemplate: JdbcTemplate) : TaskRepository {
    ...
    override fun update(id: Long, task: Task): Int {
